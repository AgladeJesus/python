print('-='*20)
print('{:=^20}'.format('CONDIÇÕES DE PAGAMENTO'))
print('-='*20)
...
if cp == 1:
    ...
    print('Valor final a Pagar: {} parcelas de R${:.2f}'.format(parc, (vlr * ((20/100)+1))/parc))
else:
    print('Essa não é uma forma de pagto valida.')
